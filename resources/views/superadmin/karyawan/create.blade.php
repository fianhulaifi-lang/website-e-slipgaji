                        ...
                        <div class="col-xl-4 mb-3">
                            ...
                            <select name="status_pegawai" class="form-control" id="status_pegawai">
                                ...
                                @foreach($statusPegawaiOptions as $s)
                                    <option value="{{ $s }}" {{ old('status_pegawai') == $s ? 'selected' : '' }}>{{ $s }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-xl-4 mb-3">
                        ...
                        <div class="col-xl-4 mb-3">
                            ...
                            <select name="status_nikah" class="form-control">
                                ...
                                @foreach($statusNikahOptions as $sn)
                                    <option value="{{ $sn }}" {{ old('status_nikah') == $sn ? 'selected' : '' }}>{{ $sn }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 mb-3">
                                ...
                                <select name="bank[]" class="form-control">
                                    ...
                                    @foreach($bankOptions as $bank)
                                        <option value="{{ $bank }}" {{ old('bank.0') == $bank ? 'selected' : '' }}>{{ $bank }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-xl-4 mb-3">
                                ...
                                <input type="text" name="no_rekening[]" class="form-control"
                                    value="{{ old('no_rekening.0') }}">
                            </div>
                            <div class="col-xl-3 mb-3">
                                <label>Atas Nama</label>
                                <input type="text" name="atas_nama[]" class="form-control"
                                    value="{{ old('atas_nama.0') }}">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" name="pendidikan_sd" class="form-control"
                                value="{{ old('pendidikan_sd') }}" placeholder="Nama sekolah & tahun">
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label>SLTP</label>
                            <input type="text" name="pendidikan_sltp" class="form-control"
                                value="{{ old('pendidikan_sltp') }}" placeholder="Nama sekolah & tahun">
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label>SLTA</label>
                            <input type="text" name="pendidikan_slta" class="form-control"
                                value="{{ old('pendidikan_slta') }}" placeholder="Nama sekolah & tahun">
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label>Perguruan Tinggi (PT)</label>
                            <input type="text" name="pendidikan_pt" class="form-control"
                                value="{{ old('pendidikan_pt') }}" placeholder="Nama kampus & tahun">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 mb-3">
                            ...
                            <input type="text" name="tahun_masuk_kuliah" class="form-control"
                                value="{{ old('tahun_masuk_kuliah') }}" placeholder="2010">
                        </div>
                        <div class="col-xl-2 mb-3">
                            <label>Tahun Keluar</label>
                            <input type="text" name="tahun_keluar_kuliah" class="form-control"
                                value="{{ old('tahun_keluar_kuliah') }}" placeholder="2014">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 mb-3">
                            ...
                            <select name="jenis_kelamin_pasangan" class="form-control">
                                <option value="">-- Pilih --</option>
                                <option value="PRIA" {{ old('jenis_kelamin_pasangan') == 'PRIA' ? 'selected' : '' }}>PRIA</option>
                                <option value="WANITA" {{ old('jenis_kelamin_pasangan') == 'WANITA' ? 'selected' : '' }}>WANITA</option>
                            </select>
                        </div>
                        <div class="col-xl-4 mb-3">
                            <label>Pendidikan Pasangan</label>
                            <input type="text" name="pendidikan_pasangan" class="form-control"
                                value="{{ old('pendidikan_pasangan') }}">
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody id="anakBody">
                                <tr>
                                    ...
                                    <td><input type="text" name="nama_anak[]" class="form-control form-control-sm" value="{{ old('nama_anak.0') }}"></td>
                                    <td><input type="text" name="tempat_lahir_anak[]" class="form-control form-control-sm" value="{{ old('tempat_lahir_anak.0') }}"></td>
                                    <td><input type="date" name="tanggal_lahir_anak[]" class="form-control form-control-sm" value="{{ old('tanggal_lahir_anak.0') }}"></td>
                                    <td><input type="text" name="pekerjaan_anak[]" class="form-control form-control-sm" value="{{ old('pekerjaan_anak.0') }}"></td>
                                    <td>
                                        <select name="jenis_kelamin_anak[]" class="form-control form-control-sm">
                                            <option value="">-</option>
                                            <option value="PRIA" {{ old('jenis_kelamin_anak.0') == 'PRIA' ? 'selected' : '' }}>PRIA</option>
                                            <option value="WANITA" {{ old('jenis_kelamin_anak.0') == 'WANITA' ? 'selected' : '' }}>WANITA</option>
                                        </select>
                                    </td>
                                    <td><input type="text" name="pendidikan_anak[]" class="form-control form-control-sm" value="{{ old('pendidikan_anak.0') }}"></td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <select name="jaminan_kesehatan" class="form-control">
                                ...
                                @foreach($jaminanOptions as $jk)
                                    <option value="{{ $jk }}" {{ old('jaminan_kesehatan') == $jk ? 'selected' : '' }}>{{ ucfirst($jk) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
